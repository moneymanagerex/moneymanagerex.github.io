...
* Files app can explore Synology Drive properly ![](files_nas.png)
* MMEX app can explore/open Synology Drive properly ![](mmex_nas.png)
* MMEX first open screen after install ![](mmex_first_open.png)
